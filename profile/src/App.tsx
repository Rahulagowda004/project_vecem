...
import { Camera, Folder, Mail, MapPin, Phone, Search, Upload, Edit2 } from 'lucide-react';
                  ...
                  {filteredFolders.map(folder => (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <Folder className="text-blue-400 group-hover:text-blue-300 transition-colors" size={24} />
                        <div>
