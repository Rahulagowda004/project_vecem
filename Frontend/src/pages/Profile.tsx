    ...
    <div className="min-h-screen bg-[#030712] flex">
      ...
      <div className="w-1/4 p-8 border-r border-gray-800">
        ...
        {isEditing && (
          <div className="mt-6 space-y-4 bg-gray-800 p-4 rounded-lg">
            <h3 className="font-semibold text-center text-gray-100">
              Edit Profile
            </h3>
            <input
              type="text"
      ...
      <div className="w-3/4 p-8">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            className="flex items-center space-x-2 bg-blue-600 px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors text-gray-100"
